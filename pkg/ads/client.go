...
// IncrementActiveRequestCount increments the active requests count for the endpoint given its address.
...
// DecrementActiveRequestCount decrements the active requests count for the endpoint given its address
