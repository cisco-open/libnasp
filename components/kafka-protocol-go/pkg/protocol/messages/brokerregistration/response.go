...
var responseBrokerEpoch = fields.Context{
...
func (o *Response) BrokerEpoch() int64 {
	return o.brokerEpoch
}

func (o *Response) SetBrokerEpoch(val int64) {
	o.isNil = false
	o.brokerEpoch = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	brokerEpochField := fields.Int64{Context: responseBrokerEpoch}
