...
var responseAssignment = fields.Context{
	SpecName:                    "Assignment",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  4,
...
func (o *Response) Assignment() []byte {
	return o.assignment
}

func (o *Response) SetAssignment(val []byte) {
	o.isNil = false
	o.assignment = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	assignmentField := fields.Bytes{Context: responseAssignment}
