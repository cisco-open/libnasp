...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/syncgroup/request"
...
var requestProtocolName = fields.Context{
...
var requestAssignments = fields.Context{
...
type Request struct {
	assignments         []request.SyncGroupRequestAssignment
...
func (o *Request) ProtocolName() fields.NullableString {
	return o.protocolName
}

func (o *Request) SetProtocolName(val fields.NullableString) {
	o.isNil = false
	o.protocolName = val
}

func (o *Request) Assignments() []request.SyncGroupRequestAssignment {
	return o.assignments
}

func (o *Request) SetAssignments(val []request.SyncGroupRequestAssignment) {
	o.isNil = false
	o.assignments = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	protocolNameField := fields.String{Context: requestProtocolName}
	if err := protocolNameField.Read(buf, version, &o.protocolName); err != nil {
		return errors.WrapIf(err, "couldn't set \"protocolName\" field")
	}

	assignmentsField := fields.ArrayOfStruct[request.SyncGroupRequestAssignment, *request.SyncGroupRequestAssignment]{Context: requestAssignments}
