...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeacls/response"
...
var responseResources = fields.Context{
	SpecName:                    "Resources",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  2,
...
type Response struct {
	resources           []response.DescribeAclsResource
...
func (o *Response) Resources() []response.DescribeAclsResource {
	return o.resources
}

func (o *Response) SetResources(val []response.DescribeAclsResource) {
	o.isNil = false
	o.resources = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resourcesField := fields.ArrayOfStruct[response.DescribeAclsResource, *response.DescribeAclsResource]{Context: responseResources}
