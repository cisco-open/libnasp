...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/deleterecords/request"
...
type Request struct {
	topics              []request.DeleteRecordsTopic
	unknownTaggedFields []fields.RawTaggedField
	timeoutMs           int32
	isNil               bool
}

func (o *Request) Topics() []request.DeleteRecordsTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.DeleteRecordsTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.DeleteRecordsTopic, *request.DeleteRecordsTopic]{Context: requestTopics}
