...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/deleterecords/response"
...
type Response struct {
	topics              []response.DeleteRecordsTopicResult
...
func (o *Response) Topics() []response.DeleteRecordsTopicResult {
	return o.topics
}

func (o *Response) SetTopics(val []response.DeleteRecordsTopicResult) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.DeleteRecordsTopicResult, *response.DeleteRecordsTopicResult]{Context: responseTopics}
