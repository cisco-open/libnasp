...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/deleteacls/response"
...
var responseFilterResults = fields.Context{
	SpecName:                    "FilterResults",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  2,
	HighestSupportedFlexVersion: 32767,
...
type Response struct {
	filterResults       []response.DeleteAclsFilterResult
...
func (o *Response) FilterResults() []response.DeleteAclsFilterResult {
	return o.filterResults
}

func (o *Response) SetFilterResults(val []response.DeleteAclsFilterResult) {
	o.isNil = false
	o.filterResults = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	filterResultsField := fields.ArrayOfStruct[response.DeleteAclsFilterResult, *response.DeleteAclsFilterResult]{Context: responseFilterResults}
	filterResults, err := filterResultsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"filterResults\" field")
	}
	o.filterResults = filterResults
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	filterResultsField := fields.ArrayOfStruct[response.DeleteAclsFilterResult, *response.DeleteAclsFilterResult]{Context: responseFilterResults}
	if err := filterResultsField.Write(buf, version, o.filterResults); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"filterResults\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayOfStructMarshalJSON("filterResults", o.filterResults); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Response) SetDefault() {
	...
	o.unknownTaggedFields = nil
	o.throttleTimeMs = 0
	for i := range o.filterResults {
		o.filterResults[i].Release()
	}
	o.filterResults = nil
...
func (o *Response) Equal(that *Response) bool {
	...
	if len(o.filterResults) != len(that.filterResults) {
		return false
	}
	for i := range o.filterResults {
		if !o.filterResults[i].Equal(&that.filterResults[i]) {
			return false
		}
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	filterResultsField := fields.ArrayOfStruct[response.DeleteAclsFilterResult, *response.DeleteAclsFilterResult]{Context: responseFilterResults}
	fieldSize, err = filterResultsField.SizeInBytes(version, o.filterResults)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"filterResults\" field")
	}
	size += fieldSize
