...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/deleteacls/request"
...
var requestFilters = fields.Context{
	SpecName:                    "Filters",
...
type Request struct {
	...
	filters             []request.DeleteAclsFilter
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Filters() []request.DeleteAclsFilter {
	return o.filters
}

func (o *Request) SetFilters(val []request.DeleteAclsFilter) {
	o.isNil = false
	o.filters = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	filtersField := fields.ArrayOfStruct[request.DeleteAclsFilter, *request.DeleteAclsFilter]{Context: requestFilters}
	filters, err := filtersField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"filters\" field")
	}
	o.filters = filters
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	filtersField := fields.ArrayOfStruct[request.DeleteAclsFilter, *request.DeleteAclsFilter]{Context: requestFilters}
	if err := filtersField.Write(buf, version, o.filters); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"filters\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayOfStructMarshalJSON("filters", o.filters); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) Equal(that *Request) bool {
	...
	if len(o.filters) != len(that.filters) {
		return false
	}
	for i := range o.filters {
		if !o.filters[i].Equal(&that.filters[i]) {
			return false
		}
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	filtersField := fields.ArrayOfStruct[request.DeleteAclsFilter, *request.DeleteAclsFilter]{Context: requestFilters}
	fieldSize, err = filtersField.SizeInBytes(version, o.filters)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"filters\" field")
	}
	size += fieldSize
