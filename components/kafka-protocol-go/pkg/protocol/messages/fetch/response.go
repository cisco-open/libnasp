...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/fetch/response"
...
var responseSessionId = fields.Context{
	SpecName:                    "SessionId",
	LowestSupportedVersion:      7,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  12,
...
type Response struct {
	responses           []response.FetchableTopicResponse
...
func (o *Response) SessionId() int32 {
	return o.sessionId
}

func (o *Response) SetSessionId(val int32) {
	o.isNil = false
	o.sessionId = val
}

func (o *Response) Responses() []response.FetchableTopicResponse {
	return o.responses
}

func (o *Response) SetResponses(val []response.FetchableTopicResponse) {
	o.isNil = false
	o.responses = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	sessionIdField := fields.Int32{Context: responseSessionId}
	if err := sessionIdField.Read(buf, version, &o.sessionId); err != nil {
		return errors.WrapIf(err, "couldn't set \"sessionId\" field")
	}

	responsesField := fields.ArrayOfStruct[response.FetchableTopicResponse, *response.FetchableTopicResponse]{Context: responseResponses}
...
func (o *Response) validateNonIgnorableFields(version int16) error {
	if !responseSessionId.IsSupportedVersion(version) {
		if o.sessionId != 0 {
			return errors.New(strings.Join([]string{"attempted to write non-default \"sessionId\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	return nil
}
