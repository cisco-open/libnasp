...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/fetch/request/fetchtopic"
...
var fetchTopicTopic = fields.Context{
	SpecName:                    "Topic",
...
var fetchTopicTopicId = fields.Context{
	SpecName:                    "TopicId",
...
var fetchTopicPartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  12,
...
type FetchTopic struct {
	partitions          []fetchtopic.FetchPartition
...
func (o *FetchTopic) Read(buf *bytes.Reader, version int16) error {
	...
	topicField := fields.String{Context: fetchTopicTopic}
	if err := topicField.Read(buf, version, &o.topic); err != nil {
		return errors.WrapIf(err, "couldn't set \"topic\" field")
	}

	topicIdField := fields.Uuid{Context: fetchTopicTopicId}
	if err := topicIdField.Read(buf, version, &o.topicId); err != nil {
		return errors.WrapIf(err, "couldn't set \"topicId\" field")
	}

	partitionsField := fields.ArrayOfStruct[fetchtopic.FetchPartition, *fetchtopic.FetchPartition]{Context: fetchTopicPartitions}
	...
	if version < FetchTopicLowestSupportedFlexVersion() || version > FetchTopicHighestSupportedFlexVersion() {
...
func (o *FetchTopic) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *FetchTopic) validateNonIgnorableFields(version int16) error {
	return nil
}
