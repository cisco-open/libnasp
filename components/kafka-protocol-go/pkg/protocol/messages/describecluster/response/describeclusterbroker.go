...
var describeClusterBrokerBrokerId = fields.Context{
	SpecName:                    "BrokerId",
...
var describeClusterBrokerHost = fields.Context{
	SpecName:                    "Host",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
...
var describeClusterBrokerPort = fields.Context{
	SpecName:                    "Port",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
...
var describeClusterBrokerRack = fields.Context{
	SpecName:           "Rack",
...
func (o *DescribeClusterBroker) BrokerId() int32 {
	return o.brokerId
}

func (o *DescribeClusterBroker) SetBrokerId(val int32) {
	o.isNil = false
	o.brokerId = val
}

func (o *DescribeClusterBroker) Host() fields.NullableString {
	return o.host
}

func (o *DescribeClusterBroker) SetHost(val fields.NullableString) {
	o.isNil = false
	o.host = val
}

func (o *DescribeClusterBroker) Port() int32 {
	return o.port
}

func (o *DescribeClusterBroker) SetPort(val int32) {
	o.isNil = false
	o.port = val
}

func (o *DescribeClusterBroker) Rack() fields.NullableString {
	return o.rack
}

func (o *DescribeClusterBroker) SetRack(val fields.NullableString) {
	o.isNil = false
	o.rack = val
}

func (o *DescribeClusterBroker) UnknownTaggedFields() []fields.RawTaggedField {
	return o.unknownTaggedFields
}

func (o *DescribeClusterBroker) SetUnknownTaggedFields(val []fields.RawTaggedField) {
	o.unknownTaggedFields = val
}

func (o *DescribeClusterBroker) Read(buf *bytes.Reader, version int16) error {
	o.SetDefault()

	brokerIdField := fields.Int32{Context: describeClusterBrokerBrokerId}
	if err := brokerIdField.Read(buf, version, &o.brokerId); err != nil {
		return errors.WrapIf(err, "couldn't set \"brokerId\" field")
	}

	hostField := fields.String{Context: describeClusterBrokerHost}
	if err := hostField.Read(buf, version, &o.host); err != nil {
		return errors.WrapIf(err, "couldn't set \"host\" field")
	}

	portField := fields.Int32{Context: describeClusterBrokerPort}
	if err := portField.Read(buf, version, &o.port); err != nil {
		return errors.WrapIf(err, "couldn't set \"port\" field")
	}

	rackField := fields.String{Context: describeClusterBrokerRack}
	...
	if version < DescribeClusterBrokerLowestSupportedFlexVersion() || version > DescribeClusterBrokerHighestSupportedFlexVersion() {
...
func (o *DescribeClusterBroker) Write(buf *typesbytes.SliceWriter, version int16) error {
	if o.IsNil() {
		return nil
	}
...
func (o *DescribeClusterBroker) String() string {
	s, err := o.MarshalJSON()
	if err != nil {
		return err.Error()
	}
...
func (o *DescribeClusterBroker) MarshalJSON() ([]byte, error) {
	if o == nil || o.IsNil() {
...
func (o *DescribeClusterBroker) IsNil() bool {
	return o.isNil
}

func (o *DescribeClusterBroker) Clear() {
	o.Release()
	o.isNil = true
...
func (o *DescribeClusterBroker) SetDefault() {
...
func (o *DescribeClusterBroker) Equal(that *DescribeClusterBroker) bool {
...
func (o *DescribeClusterBroker) SizeInBytes(version int16) (int, error) {
	if o.IsNil() {
		return 0, nil
	}
...
func (o *DescribeClusterBroker) Release() {
	if o.IsNil() {
		return
	}
...
func (o *DescribeClusterBroker) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *DescribeClusterBroker) validateNonIgnorableFields(version int16) error {
	return nil
}

func DescribeClusterBrokerLowestSupportedVersion() int16 {
	return 0
}

func DescribeClusterBrokerHighestSupportedVersion() int16 {
	return 32767
}

func DescribeClusterBrokerLowestSupportedFlexVersion() int16 {
	return 0
}

func DescribeClusterBrokerHighestSupportedFlexVersion() int16 {
	return 32767
}

func DescribeClusterBrokerDefault() DescribeClusterBroker {
	var d DescribeClusterBroker
	d.SetDefault()
