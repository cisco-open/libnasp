...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listpartitionreassignments/request"
...
type Request struct {
	topics              []request.ListPartitionReassignmentsTopics
...
func (o *Request) Topics() []request.ListPartitionReassignmentsTopics {
	return o.topics
}

func (o *Request) SetTopics(val []request.ListPartitionReassignmentsTopics) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.ListPartitionReassignmentsTopics, *request.ListPartitionReassignmentsTopics]{Context: requestTopics}
