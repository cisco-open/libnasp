...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listpartitionreassignments/response"
...
type Response struct {
	topics              []response.OngoingTopicReassignment
...
func (o *Response) Topics() []response.OngoingTopicReassignment {
	return o.topics
}

func (o *Response) SetTopics(val []response.OngoingTopicReassignment) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.OngoingTopicReassignment, *response.OngoingTopicReassignment]{Context: responseTopics}
