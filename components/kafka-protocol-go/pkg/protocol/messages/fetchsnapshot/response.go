...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/fetchsnapshot/response"
...
func (o *Response) Topics() []response.TopicSnapshot {
	return o.topics
}

func (o *Response) SetTopics(val []response.TopicSnapshot) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.TopicSnapshot, *response.TopicSnapshot]{Context: responseTopics}
