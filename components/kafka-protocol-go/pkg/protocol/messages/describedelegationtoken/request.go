...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describedelegationtoken/request"
...
var requestOwners = fields.Context{
	SpecName:                        "Owners",
...
type Request struct {
	...
	owners              []request.DescribeDelegationTokenOwner
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Owners() []request.DescribeDelegationTokenOwner {
	return o.owners
}

func (o *Request) SetOwners(val []request.DescribeDelegationTokenOwner) {
	o.isNil = false
	o.owners = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	ownersField := fields.ArrayOfStruct[request.DescribeDelegationTokenOwner, *request.DescribeDelegationTokenOwner]{Context: requestOwners}
	owners, err := ownersField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"owners\" field")
	}
	o.owners = owners
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	ownersField := fields.ArrayOfStruct[request.DescribeDelegationTokenOwner, *request.DescribeDelegationTokenOwner]{Context: requestOwners}
	if err := ownersField.Write(buf, version, o.owners); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"owners\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayOfStructMarshalJSON("owners", o.owners); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) Equal(that *Request) bool {
	...
	if len(o.owners) != len(that.owners) {
		return false
	}
	for i := range o.owners {
		if !o.owners[i].Equal(&that.owners[i]) {
			return false
		}
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	ownersField := fields.ArrayOfStruct[request.DescribeDelegationTokenOwner, *request.DescribeDelegationTokenOwner]{Context: requestOwners}
	fieldSize, err = ownersField.SizeInBytes(version, o.owners)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"owners\" field")
	}
	size += fieldSize
