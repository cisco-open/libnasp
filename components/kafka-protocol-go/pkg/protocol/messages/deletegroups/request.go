...
var requestGroupsNames = fields.Context{
	SpecName:                    "GroupsNames",
...
type Request struct {
	...
	groupsNames         []fields.NullableString
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	groupsNamesField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestGroupsNames,
		ElementProcessor: &fields.String{Context: requestGroupsNames}}

	groupsNames, err := groupsNamesField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"groupsNames\" field")
	}
	o.groupsNames = groupsNames
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	groupsNamesField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestGroupsNames,
		ElementProcessor: &fields.String{Context: requestGroupsNames}}
	if err := groupsNamesField.Write(buf, version, o.groupsNames); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"groupsNames\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayMarshalJSON("groupsNames", o.groupsNames); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) SetDefault() {
	...
	o.unknownTaggedFields = nil
	for i := range o.groupsNames {
		o.groupsNames[i].Release()
	}
	o.groupsNames = nil
...
func (o *Request) Equal(that *Request) bool {
	...
	if !fields.NullableStringSliceEqual(o.groupsNames, that.groupsNames) {
		return false
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	groupsNamesField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestGroupsNames,
		ElementProcessor: &fields.String{Context: requestGroupsNames}}
	fieldSize, err = groupsNamesField.SizeInBytes(version, o.groupsNames)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"groupsNames\" field")
	}
	size += fieldSize
