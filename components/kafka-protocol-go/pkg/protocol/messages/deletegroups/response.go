...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/deletegroups/response"
...
type Response struct {
	results             []response.DeletableGroupResult
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.DeletableGroupResult, *response.DeletableGroupResult]{Context: responseResults}
