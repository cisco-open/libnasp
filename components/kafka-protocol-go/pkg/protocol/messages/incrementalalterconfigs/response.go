...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/incrementalalterconfigs/response"
...
type Response struct {
	responses           []response.AlterConfigsResourceResponse
...
func (o *Response) Responses() []response.AlterConfigsResourceResponse {
	return o.responses
}

func (o *Response) SetResponses(val []response.AlterConfigsResourceResponse) {
	o.isNil = false
	o.responses = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	responsesField := fields.ArrayOfStruct[response.AlterConfigsResourceResponse, *response.AlterConfigsResourceResponse]{Context: responseResponses}
