...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterpartitionreassignments/response"
...
type Response struct {
	responses           []response.ReassignableTopicResponse
...
func (o *Response) Responses() []response.ReassignableTopicResponse {
	return o.responses
}

func (o *Response) SetResponses(val []response.ReassignableTopicResponse) {
	o.isNil = false
	o.responses = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	responsesField := fields.ArrayOfStruct[response.ReassignableTopicResponse, *response.ReassignableTopicResponse]{Context: responseResponses}
