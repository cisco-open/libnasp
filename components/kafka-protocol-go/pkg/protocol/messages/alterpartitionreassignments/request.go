...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterpartitionreassignments/request"
...
type Request struct {
	topics              []request.ReassignableTopic
...
func (o *Request) Topics() []request.ReassignableTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.ReassignableTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.ReassignableTopic, *request.ReassignableTopic]{Context: requestTopics}
