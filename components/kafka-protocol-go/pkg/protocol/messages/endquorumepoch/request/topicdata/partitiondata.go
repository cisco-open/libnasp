...
var partitionDataPreferredSuccessors = fields.Context{
	SpecName:                    "PreferredSuccessors",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  32767,
	HighestSupportedFlexVersion: 32767,
...
func (o *PartitionData) PreferredSuccessors() []int32 {
	return o.preferredSuccessors
}

func (o *PartitionData) SetPreferredSuccessors(val []int32) {
	o.isNil = false
	o.preferredSuccessors = val
}
...
func (o *PartitionData) Read(buf *bytes.Reader, version int16) error {
	...
	preferredSuccessorsField := fields.Array[int32, *fields.Int32]{
		Context:          partitionDataPreferredSuccessors,
		ElementProcessor: &fields.Int32{Context: partitionDataPreferredSuccessors}}

	preferredSuccessors, err := preferredSuccessorsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"preferredSuccessors\" field")
	}
	o.preferredSuccessors = preferredSuccessors
...
func (o *PartitionData) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	preferredSuccessorsField := fields.Array[int32, *fields.Int32]{
		Context:          partitionDataPreferredSuccessors,
		ElementProcessor: &fields.Int32{Context: partitionDataPreferredSuccessors}}
	if err := preferredSuccessorsField.Write(buf, version, o.preferredSuccessors); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"preferredSuccessors\" field")
	}
...
func (o *PartitionData) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayMarshalJSON("preferredSuccessors", o.preferredSuccessors); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *PartitionData) Equal(that *PartitionData) bool {
	...
	if !fields.PrimitiveTypeSliceEqual(o.preferredSuccessors, that.preferredSuccessors) {
		return false
	}
...
func (o *PartitionData) SizeInBytes(version int16) (int, error) {
	...
	preferredSuccessorsField := fields.Array[int32, *fields.Int32]{
		Context:          partitionDataPreferredSuccessors,
		ElementProcessor: &fields.Int32{Context: partitionDataPreferredSuccessors}}
	fieldSize, err = preferredSuccessorsField.SizeInBytes(version, o.preferredSuccessors)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"preferredSuccessors\" field")
	}
	size += fieldSize
