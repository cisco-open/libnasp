...
var partitionDataVoteGranted = fields.Context{
	SpecName:                    "VoteGranted",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
...
func (o *PartitionData) VoteGranted() bool {
	return o.voteGranted
}

func (o *PartitionData) SetVoteGranted(val bool) {
	o.isNil = false
	o.voteGranted = val
}
...
func (o *PartitionData) Read(buf *bytes.Reader, version int16) error {
	...
	voteGrantedField := fields.Bool{Context: partitionDataVoteGranted}
	if err := voteGrantedField.Read(buf, version, &o.voteGranted); err != nil {
		return errors.WrapIf(err, "couldn't set \"voteGranted\" field")
	}
...
func (o *PartitionData) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	voteGrantedField := fields.Bool{Context: partitionDataVoteGranted}
	if err := voteGrantedField.Write(buf, version, o.voteGranted); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"voteGranted\" field")
	}
...
func (o *PartitionData) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.voteGranted); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"voteGranted\""), b}, []byte(": ")))
	}
...
func (o *PartitionData) Equal(that *PartitionData) bool {
	...
	if o.voteGranted != that.voteGranted {
		return false
	}
...
func (o *PartitionData) SizeInBytes(version int16) (int, error) {
	...
	voteGrantedField := fields.Bool{Context: partitionDataVoteGranted}
	fieldSize, err = voteGrantedField.SizeInBytes(version, o.voteGranted)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"voteGranted\" field")
	}
	size += fieldSize
