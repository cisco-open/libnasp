...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterclientquotas/response/entrydata"
...
var entryDataErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
...
var entryDataErrorMessage = fields.Context{
...
func (o *EntryData) Read(buf *bytes.Reader, version int16) error {
	...
	errorCodeField := fields.Int16{Context: entryDataErrorCode}
	if err := errorCodeField.Read(buf, version, &o.errorCode); err != nil {
		return errors.WrapIf(err, "couldn't set \"errorCode\" field")
	}

	errorMessageField := fields.String{Context: entryDataErrorMessage}
