...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/stopreplica/response"
...
type Response struct {
	partitionErrors     []response.StopReplicaPartitionError
...
func (o *Response) PartitionErrors() []response.StopReplicaPartitionError {
	return o.partitionErrors
}

func (o *Response) SetPartitionErrors(val []response.StopReplicaPartitionError) {
	o.isNil = false
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	partitionErrorsField := fields.ArrayOfStruct[response.StopReplicaPartitionError, *response.StopReplicaPartitionError]{Context: responsePartitionErrors}
