...
var stopReplicaTopicV1Name = fields.Context{
	SpecName:                    "Name",
...
var stopReplicaTopicV1PartitionIndexes = fields.Context{
...
func (o *StopReplicaTopicV1) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: stopReplicaTopicV1Name}
	...
	partitionIndexesField := fields.Array[int32, *fields.Int32]{
		Context:          stopReplicaTopicV1PartitionIndexes,
		ElementProcessor: &fields.Int32{Context: stopReplicaTopicV1PartitionIndexes}}
	...
	if version < StopReplicaTopicV1LowestSupportedFlexVersion() || version > StopReplicaTopicV1HighestSupportedFlexVersion() {
...
func (o *StopReplicaTopicV1) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *StopReplicaTopicV1) validateNonIgnorableFields(version int16) error {
	if !stopReplicaTopicV1Name.IsSupportedVersion(version) {
		if o.name.Bytes() != nil {
			return errors.New(strings.Join([]string{"attempted to write non-default \"name\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	if !stopReplicaTopicV1PartitionIndexes.IsSupportedVersion(version) {
