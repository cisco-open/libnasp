...
var responseMechanisms = fields.Context{
	SpecName:                    "Mechanisms",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  32767,
...
type Response struct {
	mechanisms          []fields.NullableString
...
func (o *Response) Mechanisms() []fields.NullableString {
	return o.mechanisms
}

func (o *Response) SetMechanisms(val []fields.NullableString) {
	o.isNil = false
	o.mechanisms = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	mechanismsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseMechanisms,
		ElementProcessor: &fields.String{Context: responseMechanisms}}

	mechanisms, err := mechanismsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"mechanisms\" field")
	}
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	mechanismsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseMechanisms,
		ElementProcessor: &fields.String{Context: responseMechanisms}}
	if err := mechanismsField.Write(buf, version, o.mechanisms); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"mechanisms\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayMarshalJSON("mechanisms", o.mechanisms); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Response) SetDefault() {
	...
	o.unknownTaggedFields = nil
	o.errorCode = 0
	for i := range o.mechanisms {
		o.mechanisms[i].Release()
	}
	o.mechanisms = nil
...
func (o *Response) Equal(that *Response) bool {
	...
	if !fields.NullableStringSliceEqual(o.mechanisms, that.mechanisms) {
		return false
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	mechanismsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseMechanisms,
		ElementProcessor: &fields.String{Context: responseMechanisms}}
	fieldSize, err = mechanismsField.SizeInBytes(version, o.mechanisms)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"mechanisms\" field")
	}
	size += fieldSize
