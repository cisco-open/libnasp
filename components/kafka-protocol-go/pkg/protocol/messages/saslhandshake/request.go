...
var requestMechanism = fields.Context{
	SpecName:                    "Mechanism",
...
type Request struct {
	...
	mechanism           fields.NullableString
	isNil               bool
}

func (o *Request) Mechanism() fields.NullableString {
	return o.mechanism
}

func (o *Request) SetMechanism(val fields.NullableString) {
	o.isNil = false
	o.mechanism = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	mechanismField := fields.String{Context: requestMechanism}
...
func (o *Request) Equal(that *Request) bool {
	...
	if !o.mechanism.Equal(&that.mechanism) {
		return false
	}
