...
var deleteTopicStateName = fields.Context{
	SpecName:           "Name",
...
var deleteTopicStateTopicId = fields.Context{
	SpecName:                    "TopicId",
	LowestSupportedVersion:      6,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  4,
...
func (o *DeleteTopicState) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: deleteTopicStateName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	topicIdField := fields.Uuid{Context: deleteTopicStateTopicId}
	...
	if version < DeleteTopicStateLowestSupportedFlexVersion() || version > DeleteTopicStateHighestSupportedFlexVersion() {
...
func (o *DeleteTopicState) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *DeleteTopicState) validateNonIgnorableFields(version int16) error {
	if !deleteTopicStateName.IsSupportedVersion(version) {
		if !o.name.IsNil() {
			return errors.New(strings.Join([]string{"attempted to write non-default \"name\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	if !deleteTopicStateTopicId.IsSupportedVersion(version) {
		if !o.topicId.IsZero() {
