...
var deletableTopicResultName = fields.Context{
	SpecName:                        "Name",
	LowestSupportedVersion:          0,
	HighestSupportedVersion:         32767,
	LowestSupportedFlexVersion:      4,
	HighestSupportedFlexVersion:     32767,
	LowestSupportedNullableVersion:  6,
	HighestSupportedNullableVersion: 32767,
}
var deletableTopicResultTopicId = fields.Context{
	SpecName:                    "TopicId",
...
var deletableTopicResultErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  4,
...
var deletableTopicResultErrorMessage = fields.Context{
...
func (o *DeletableTopicResult) Name() fields.NullableString {
	return o.name
}

func (o *DeletableTopicResult) SetName(val fields.NullableString) {
	o.isNil = false
	o.name = val
}

func (o *DeletableTopicResult) TopicId() fields.UUID {
	return o.topicId
}

func (o *DeletableTopicResult) SetTopicId(val fields.UUID) {
	o.isNil = false
	o.topicId = val
}

func (o *DeletableTopicResult) ErrorCode() int16 {
	return o.errorCode
}

func (o *DeletableTopicResult) SetErrorCode(val int16) {
	o.isNil = false
	o.errorCode = val
}

func (o *DeletableTopicResult) ErrorMessage() fields.NullableString {
	return o.errorMessage
}

func (o *DeletableTopicResult) SetErrorMessage(val fields.NullableString) {
	o.isNil = false
	o.errorMessage = val
}

func (o *DeletableTopicResult) UnknownTaggedFields() []fields.RawTaggedField {
	return o.unknownTaggedFields
}

func (o *DeletableTopicResult) SetUnknownTaggedFields(val []fields.RawTaggedField) {
	o.unknownTaggedFields = val
}

func (o *DeletableTopicResult) Read(buf *bytes.Reader, version int16) error {
	o.SetDefault()

	nameField := fields.String{Context: deletableTopicResultName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	topicIdField := fields.Uuid{Context: deletableTopicResultTopicId}
	if err := topicIdField.Read(buf, version, &o.topicId); err != nil {
		return errors.WrapIf(err, "couldn't set \"topicId\" field")
	}

	errorCodeField := fields.Int16{Context: deletableTopicResultErrorCode}
	if err := errorCodeField.Read(buf, version, &o.errorCode); err != nil {
		return errors.WrapIf(err, "couldn't set \"errorCode\" field")
	}

	errorMessageField := fields.String{Context: deletableTopicResultErrorMessage}
	...
	if version < DeletableTopicResultLowestSupportedFlexVersion() || version > DeletableTopicResultHighestSupportedFlexVersion() {
...
func (o *DeletableTopicResult) Write(buf *typesbytes.SliceWriter, version int16) error {
	if o.IsNil() {
		return nil
	}
...
func (o *DeletableTopicResult) String() string {
	s, err := o.MarshalJSON()
	if err != nil {
		return err.Error()
	}
...
func (o *DeletableTopicResult) MarshalJSON() ([]byte, error) {
	if o == nil || o.IsNil() {
...
func (o *DeletableTopicResult) IsNil() bool {
	return o.isNil
}

func (o *DeletableTopicResult) Clear() {
	o.Release()
	o.isNil = true
...
func (o *DeletableTopicResult) SetDefault() {
...
func (o *DeletableTopicResult) Equal(that *DeletableTopicResult) bool {
...
func (o *DeletableTopicResult) SizeInBytes(version int16) (int, error) {
	if o.IsNil() {
		return 0, nil
	}
...
func (o *DeletableTopicResult) Release() {
	if o.IsNil() {
		return
	}
...
func (o *DeletableTopicResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *DeletableTopicResult) validateNonIgnorableFields(version int16) error {
	return nil
}

func DeletableTopicResultLowestSupportedVersion() int16 {
	return 0
}

func DeletableTopicResultHighestSupportedVersion() int16 {
	return 32767
}

func DeletableTopicResultLowestSupportedFlexVersion() int16 {
	return 4
}

func DeletableTopicResultHighestSupportedFlexVersion() int16 {
	return 32767
}

func DeletableTopicResultDefault() DeletableTopicResult {
	var d DeletableTopicResult
	d.SetDefault()
