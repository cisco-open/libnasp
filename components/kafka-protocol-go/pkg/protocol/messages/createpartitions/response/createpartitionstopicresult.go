...
var createPartitionsTopicResultName = fields.Context{
	SpecName:                    "Name",
...
var createPartitionsTopicResultErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  2,
...
var createPartitionsTopicResultErrorMessage = fields.Context{
...
func (o *CreatePartitionsTopicResult) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: createPartitionsTopicResultName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	errorCodeField := fields.Int16{Context: createPartitionsTopicResultErrorCode}
	if err := errorCodeField.Read(buf, version, &o.errorCode); err != nil {
		return errors.WrapIf(err, "couldn't set \"errorCode\" field")
	}

	errorMessageField := fields.String{Context: createPartitionsTopicResultErrorMessage}
	...
	if version < CreatePartitionsTopicResultLowestSupportedFlexVersion() || version > CreatePartitionsTopicResultHighestSupportedFlexVersion() {
...
func (o *CreatePartitionsTopicResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *CreatePartitionsTopicResult) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func CreatePartitionsTopicResultDefault() CreatePartitionsTopicResult {
	var d CreatePartitionsTopicResult
	d.SetDefault()
