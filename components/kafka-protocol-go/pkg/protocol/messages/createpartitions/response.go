...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/createpartitions/response"
...
type Response struct {
	results             []response.CreatePartitionsTopicResult
...
func (o *Response) Results() []response.CreatePartitionsTopicResult {
	return o.results
}

func (o *Response) SetResults(val []response.CreatePartitionsTopicResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.CreatePartitionsTopicResult, *response.CreatePartitionsTopicResult]{Context: responseResults}
