...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/createpartitions/request"
...
type Request struct {
	topics              []request.CreatePartitionsTopic
...
func (o *Request) Topics() []request.CreatePartitionsTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.CreatePartitionsTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.CreatePartitionsTopic, *request.CreatePartitionsTopic]{Context: requestTopics}
