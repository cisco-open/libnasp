...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/createacls/response"
...
type Response struct {
	results             []response.AclCreationResult
...
func (o *Response) Results() []response.AclCreationResult {
	return o.results
}

func (o *Response) SetResults(val []response.AclCreationResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.AclCreationResult, *response.AclCreationResult]{Context: responseResults}
