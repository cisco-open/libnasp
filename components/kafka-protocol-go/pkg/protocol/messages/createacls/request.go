...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/createacls/request"
...
var requestCreations = fields.Context{
	SpecName:                    "Creations",
...
type Request struct {
	...
	creations           []request.AclCreation
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Creations() []request.AclCreation {
	return o.creations
}

func (o *Request) SetCreations(val []request.AclCreation) {
	o.isNil = false
	o.creations = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	creationsField := fields.ArrayOfStruct[request.AclCreation, *request.AclCreation]{Context: requestCreations}
	creations, err := creationsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"creations\" field")
	}
	o.creations = creations
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	creationsField := fields.ArrayOfStruct[request.AclCreation, *request.AclCreation]{Context: requestCreations}
	if err := creationsField.Write(buf, version, o.creations); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"creations\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayOfStructMarshalJSON("creations", o.creations); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) SetDefault() {
	...
	o.unknownTaggedFields = nil
	for i := range o.creations {
		o.creations[i].Release()
	}
	o.creations = nil
...
func (o *Request) Equal(that *Request) bool {
	...
	if len(o.creations) != len(that.creations) {
		return false
	}
	for i := range o.creations {
		if !o.creations[i].Equal(&that.creations[i]) {
			return false
		}
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	creationsField := fields.ArrayOfStruct[request.AclCreation, *request.AclCreation]{Context: requestCreations}
	fieldSize, err = creationsField.SizeInBytes(version, o.creations)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"creations\" field")
	}
	size += fieldSize
