...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describelogdirs/response"
...
type Response struct {
	results             []response.DescribeLogDirsResult
...
func (o *Response) Results() []response.DescribeLogDirsResult {
	return o.results
}

func (o *Response) SetResults(val []response.DescribeLogDirsResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.DescribeLogDirsResult, *response.DescribeLogDirsResult]{Context: responseResults}
