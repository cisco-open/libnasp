...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describelogdirs/request"
...
type Request struct {
	...
	topics              []request.DescribableLogDirTopic
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Topics() []request.DescribableLogDirTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.DescribableLogDirTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.DescribableLogDirTopic, *request.DescribableLogDirTopic]{Context: requestTopics}
