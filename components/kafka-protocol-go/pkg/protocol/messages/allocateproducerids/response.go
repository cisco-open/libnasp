...
var responseProducerIdStart = fields.Context{
	SpecName:                    "ProducerIdStart",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
}
var responseProducerIdLen = fields.Context{
	SpecName:                    "ProducerIdLen",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
...
func (o *Response) ProducerIdStart() int64 {
	return o.producerIdStart
}

func (o *Response) SetProducerIdStart(val int64) {
	o.isNil = false
	o.producerIdStart = val
}

func (o *Response) ProducerIdLen() int32 {
	return o.producerIdLen
}

func (o *Response) SetProducerIdLen(val int32) {
	o.isNil = false
	o.producerIdLen = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	producerIdStartField := fields.Int64{Context: responseProducerIdStart}
	if err := producerIdStartField.Read(buf, version, &o.producerIdStart); err != nil {
		return errors.WrapIf(err, "couldn't set \"producerIdStart\" field")
	}

	producerIdLenField := fields.Int32{Context: responseProducerIdLen}
	if err := producerIdLenField.Read(buf, version, &o.producerIdLen); err != nil {
		return errors.WrapIf(err, "couldn't set \"producerIdLen\" field")
	}
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	producerIdStartField := fields.Int64{Context: responseProducerIdStart}
	if err := producerIdStartField.Write(buf, version, o.producerIdStart); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"producerIdStart\" field")
	}
	producerIdLenField := fields.Int32{Context: responseProducerIdLen}
	if err := producerIdLenField.Write(buf, version, o.producerIdLen); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"producerIdLen\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.producerIdStart); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"producerIdStart\""), b}, []byte(": ")))
	}
	if b, err := fields.MarshalPrimitiveTypeJSON(o.producerIdLen); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"producerIdLen\""), b}, []byte(": ")))
	}
...
func (o *Response) Equal(that *Response) bool {
	...
	if o.producerIdStart != that.producerIdStart {
		return false
	}
	if o.producerIdLen != that.producerIdLen {
		return false
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	producerIdStartField := fields.Int64{Context: responseProducerIdStart}
	fieldSize, err = producerIdStartField.SizeInBytes(version, o.producerIdStart)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"producerIdStart\" field")
	}
	size += fieldSize

	producerIdLenField := fields.Int32{Context: responseProducerIdLen}
	fieldSize, err = producerIdLenField.SizeInBytes(version, o.producerIdLen)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"producerIdLen\" field")
	}
	size += fieldSize
