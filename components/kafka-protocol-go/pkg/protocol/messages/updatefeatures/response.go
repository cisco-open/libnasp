...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/updatefeatures/response"
...
type Response struct {
	results             []response.UpdatableFeatureResult
...
func (o *Response) Results() []response.UpdatableFeatureResult {
	return o.results
}

func (o *Response) SetResults(val []response.UpdatableFeatureResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.UpdatableFeatureResult, *response.UpdatableFeatureResult]{Context: responseResults}
