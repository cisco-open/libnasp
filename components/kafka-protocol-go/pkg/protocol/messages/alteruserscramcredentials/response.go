...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alteruserscramcredentials/response"
...
type Response struct {
	results             []response.AlterUserScramCredentialsResult
...
func (o *Response) Results() []response.AlterUserScramCredentialsResult {
	return o.results
}

func (o *Response) SetResults(val []response.AlterUserScramCredentialsResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.AlterUserScramCredentialsResult, *response.AlterUserScramCredentialsResult]{Context: responseResults}
