...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/produce/response/topicproduceresponse"
...
var topicProduceResponseName = fields.Context{
	SpecName:                    "Name",
...
var topicProduceResponsePartitionResponses = fields.Context{
	SpecName:                    "PartitionResponses",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  9,
	HighestSupportedFlexVersion: 32767,
...
type TopicProduceResponse struct {
	partitionResponses  []topicproduceresponse.PartitionProduceResponse
...
func (o *TopicProduceResponse) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: topicProduceResponseName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionResponsesField := fields.ArrayOfStruct[topicproduceresponse.PartitionProduceResponse, *topicproduceresponse.PartitionProduceResponse]{Context: topicProduceResponsePartitionResponses}
	partitionResponses, err := partitionResponsesField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"partitionResponses\" field")
	}
	o.partitionResponses = partitionResponses

	// process tagged fields

	if version < TopicProduceResponseLowestSupportedFlexVersion() || version > TopicProduceResponseHighestSupportedFlexVersion() {
...
func (o *TopicProduceResponse) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	partitionResponsesField := fields.ArrayOfStruct[topicproduceresponse.PartitionProduceResponse, *topicproduceresponse.PartitionProduceResponse]{Context: topicProduceResponsePartitionResponses}
	if err := partitionResponsesField.Write(buf, version, o.partitionResponses); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"partitionResponses\" field")
	}
...
func (o *TopicProduceResponse) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayOfStructMarshalJSON("partitionResponses", o.partitionResponses); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *TopicProduceResponse) SetDefault() {
	...
	o.unknownTaggedFields = nil
	o.name.SetValue("")
	for i := range o.partitionResponses {
		o.partitionResponses[i].Release()
	}
	o.partitionResponses = nil
...
func (o *TopicProduceResponse) Equal(that *TopicProduceResponse) bool {
	...
	if len(o.partitionResponses) != len(that.partitionResponses) {
		return false
	}
	for i := range o.partitionResponses {
		if !o.partitionResponses[i].Equal(&that.partitionResponses[i]) {
			return false
		}
	}
...
func (o *TopicProduceResponse) SizeInBytes(version int16) (int, error) {
	...
	partitionResponsesField := fields.ArrayOfStruct[topicproduceresponse.PartitionProduceResponse, *topicproduceresponse.PartitionProduceResponse]{Context: topicProduceResponsePartitionResponses}
	fieldSize, err = partitionResponsesField.SizeInBytes(version, o.partitionResponses)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"partitionResponses\" field")
	}
	size += fieldSize
...
func (o *TopicProduceResponse) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *TopicProduceResponse) validateNonIgnorableFields(version int16) error {
	return nil
}
