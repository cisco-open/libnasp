...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/txnoffsetcommit/response/txnoffsetcommitresponsetopic"
...
var txnOffsetCommitResponseTopicName = fields.Context{
	SpecName:                    "Name",
...
var txnOffsetCommitResponseTopicPartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  3,
...
type TxnOffsetCommitResponseTopic struct {
	partitions          []txnoffsetcommitresponsetopic.TxnOffsetCommitResponsePartition
...
func (o *TxnOffsetCommitResponseTopic) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: txnOffsetCommitResponseTopicName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionsField := fields.ArrayOfStruct[txnoffsetcommitresponsetopic.TxnOffsetCommitResponsePartition, *txnoffsetcommitresponsetopic.TxnOffsetCommitResponsePartition]{Context: txnOffsetCommitResponseTopicPartitions}
	...
	if version < TxnOffsetCommitResponseTopicLowestSupportedFlexVersion() || version > TxnOffsetCommitResponseTopicHighestSupportedFlexVersion() {
...
func (o *TxnOffsetCommitResponseTopic) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *TxnOffsetCommitResponseTopic) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func TxnOffsetCommitResponseTopicDefault() TxnOffsetCommitResponseTopic {
	var d TxnOffsetCommitResponseTopic
	d.SetDefault()
