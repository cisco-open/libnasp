...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/txnoffsetcommit/response"
...
type Response struct {
	topics              []response.TxnOffsetCommitResponseTopic
...
func (o *Response) Topics() []response.TxnOffsetCommitResponseTopic {
	return o.topics
}

func (o *Response) SetTopics(val []response.TxnOffsetCommitResponseTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.TxnOffsetCommitResponseTopic, *response.TxnOffsetCommitResponseTopic]{Context: responseTopics}
