...
package offsetfetchresponsegroup
...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetfetch/response/offsetfetchresponsegroup/offsetfetchresponsetopics"
...
var offsetFetchResponseTopicsName = fields.Context{
	SpecName:                    "Name",
...
var offsetFetchResponseTopicsPartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      8,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  6,
...
type OffsetFetchResponseTopics struct {
	partitions          []offsetfetchresponsetopics.OffsetFetchResponsePartitions
...
func (o *OffsetFetchResponseTopics) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: offsetFetchResponseTopicsName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionsField := fields.ArrayOfStruct[offsetfetchresponsetopics.OffsetFetchResponsePartitions, *offsetfetchresponsetopics.OffsetFetchResponsePartitions]{Context: offsetFetchResponseTopicsPartitions}
	...
	if version < OffsetFetchResponseTopicsLowestSupportedFlexVersion() || version > OffsetFetchResponseTopicsHighestSupportedFlexVersion() {
...
func (o *OffsetFetchResponseTopics) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *OffsetFetchResponseTopics) validateNonIgnorableFields(version int16) error {
	if !offsetFetchResponseTopicsName.IsSupportedVersion(version) {
		if o.name.Bytes() != nil {
			return errors.New(strings.Join([]string{"attempted to write non-default \"name\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	if !offsetFetchResponseTopicsPartitions.IsSupportedVersion(version) {
...
func OffsetFetchResponseTopicsDefault() OffsetFetchResponseTopics {
	var d OffsetFetchResponseTopics
	d.SetDefault()
