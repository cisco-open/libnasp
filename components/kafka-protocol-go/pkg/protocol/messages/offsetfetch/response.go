...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetfetch/response"
...
var responseGroups = fields.Context{
	SpecName:                    "Groups",
...
type Response struct {
	topics              []response.OffsetFetchResponseTopic
	groups              []response.OffsetFetchResponseGroup
...
func (o *Response) Topics() []response.OffsetFetchResponseTopic {
	return o.topics
}

func (o *Response) SetTopics(val []response.OffsetFetchResponseTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Groups() []response.OffsetFetchResponseGroup {
	return o.groups
}

func (o *Response) SetGroups(val []response.OffsetFetchResponseGroup) {
	o.isNil = false
	o.groups = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.OffsetFetchResponseTopic, *response.OffsetFetchResponseTopic]{Context: responseTopics}
	...
	groupsField := fields.ArrayOfStruct[response.OffsetFetchResponseGroup, *response.OffsetFetchResponseGroup]{Context: responseGroups}
...
func (o *Response) validateNonIgnorableFields(version int16) error {
	if !responseGroups.IsSupportedVersion(version) {
		if len(o.groups) > 0 {
