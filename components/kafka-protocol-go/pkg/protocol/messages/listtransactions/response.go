...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listtransactions/response"
...
var responseUnknownStateFilters = fields.Context{
	SpecName:                    "UnknownStateFilters",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
...
type Response struct {
	unknownStateFilters []fields.NullableString
...
func (o *Response) UnknownStateFilters() []fields.NullableString {
	return o.unknownStateFilters
}

func (o *Response) SetUnknownStateFilters(val []fields.NullableString) {
	o.isNil = false
	o.unknownStateFilters = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	unknownStateFiltersField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseUnknownStateFilters,
		ElementProcessor: &fields.String{Context: responseUnknownStateFilters}}

	unknownStateFilters, err := unknownStateFiltersField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"unknownStateFilters\" field")
	}
	o.unknownStateFilters = unknownStateFilters
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	unknownStateFiltersField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseUnknownStateFilters,
		ElementProcessor: &fields.String{Context: responseUnknownStateFilters}}
	if err := unknownStateFiltersField.Write(buf, version, o.unknownStateFilters); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"unknownStateFilters\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayMarshalJSON("unknownStateFilters", o.unknownStateFilters); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Response) SetDefault() {
	...
	o.throttleTimeMs = 0
	o.errorCode = 0
	for i := range o.unknownStateFilters {
		o.unknownStateFilters[i].Release()
	}
	o.unknownStateFilters = nil
...
func (o *Response) Equal(that *Response) bool {
	...
	if !fields.NullableStringSliceEqual(o.unknownStateFilters, that.unknownStateFilters) {
		return false
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	unknownStateFiltersField := fields.Array[fields.NullableString, *fields.String]{
		Context:          responseUnknownStateFilters,
		ElementProcessor: &fields.String{Context: responseUnknownStateFilters}}
	fieldSize, err = unknownStateFiltersField.SizeInBytes(version, o.unknownStateFilters)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"unknownStateFilters\" field")
	}
	size += fieldSize
