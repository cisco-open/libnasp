...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeclientquotas/response"
...
var responseEntries = fields.Context{
	SpecName:                        "Entries",
	LowestSupportedVersion:          0,
	HighestSupportedVersion:         32767,
	LowestSupportedFlexVersion:      1,
...
func (o *Response) Entries() []response.EntryData {
	return o.entries
}

func (o *Response) SetEntries(val []response.EntryData) {
	o.isNil = false
	o.entries = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	entriesField := fields.ArrayOfStruct[response.EntryData, *response.EntryData]{Context: responseEntries}
