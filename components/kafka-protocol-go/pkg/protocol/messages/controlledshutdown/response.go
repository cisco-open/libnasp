...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/controlledshutdown/response"
...
var responseRemainingPartitions = fields.Context{
	SpecName:                    "RemainingPartitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  3,
	HighestSupportedFlexVersion: 32767,
...
type Response struct {
	remainingPartitions []response.RemainingPartition
...
func (o *Response) RemainingPartitions() []response.RemainingPartition {
	return o.remainingPartitions
}

func (o *Response) SetRemainingPartitions(val []response.RemainingPartition) {
	o.isNil = false
	o.remainingPartitions = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	remainingPartitionsField := fields.ArrayOfStruct[response.RemainingPartition, *response.RemainingPartition]{Context: responseRemainingPartitions}
	remainingPartitions, err := remainingPartitionsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"remainingPartitions\" field")
	}
	o.remainingPartitions = remainingPartitions
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	remainingPartitionsField := fields.ArrayOfStruct[response.RemainingPartition, *response.RemainingPartition]{Context: responseRemainingPartitions}
	if err := remainingPartitionsField.Write(buf, version, o.remainingPartitions); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"remainingPartitions\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayOfStructMarshalJSON("remainingPartitions", o.remainingPartitions); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Response) SetDefault() {
	...
	o.unknownTaggedFields = nil
	o.errorCode = 0
	for i := range o.remainingPartitions {
		o.remainingPartitions[i].Release()
	}
	o.remainingPartitions = nil
...
func (o *Response) Equal(that *Response) bool {
	...
	if len(o.remainingPartitions) != len(that.remainingPartitions) {
		return false
	}
	for i := range o.remainingPartitions {
		if !o.remainingPartitions[i].Equal(&that.remainingPartitions[i]) {
			return false
		}
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	remainingPartitionsField := fields.ArrayOfStruct[response.RemainingPartition, *response.RemainingPartition]{Context: responseRemainingPartitions}
	fieldSize, err = remainingPartitionsField.SizeInBytes(version, o.remainingPartitions)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"remainingPartitions\" field")
	}
	size += fieldSize
