...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listgroups/response"
...
func (o *Response) Groups() []response.ListedGroup {
	return o.groups
}

func (o *Response) SetGroups(val []response.ListedGroup) {
	o.isNil = false
	o.groups = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	groupsField := fields.ArrayOfStruct[response.ListedGroup, *response.ListedGroup]{Context: responseGroups}
