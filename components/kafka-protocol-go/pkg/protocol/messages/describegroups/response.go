...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describegroups/response"
...
type Response struct {
	groups              []response.DescribedGroup
...
func (o *Response) Groups() []response.DescribedGroup {
	return o.groups
}

func (o *Response) SetGroups(val []response.DescribedGroup) {
	o.isNil = false
	o.groups = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	groupsField := fields.ArrayOfStruct[response.DescribedGroup, *response.DescribedGroup]{Context: responseGroups}
