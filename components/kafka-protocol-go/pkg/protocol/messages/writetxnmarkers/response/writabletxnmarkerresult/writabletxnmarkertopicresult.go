...
package writabletxnmarkerresult
...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/writetxnmarkers/response/writabletxnmarkerresult/writabletxnmarkertopicresult"
...
var writableTxnMarkerTopicResultName = fields.Context{
	SpecName:                    "Name",
...
var writableTxnMarkerTopicResultPartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  1,
...
type WritableTxnMarkerTopicResult struct {
	partitions          []writabletxnmarkertopicresult.WritableTxnMarkerPartitionResult
...
func (o *WritableTxnMarkerTopicResult) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: writableTxnMarkerTopicResultName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionsField := fields.ArrayOfStruct[writabletxnmarkertopicresult.WritableTxnMarkerPartitionResult, *writabletxnmarkertopicresult.WritableTxnMarkerPartitionResult]{Context: writableTxnMarkerTopicResultPartitions}
	...
	if version < WritableTxnMarkerTopicResultLowestSupportedFlexVersion() || version > WritableTxnMarkerTopicResultHighestSupportedFlexVersion() {
...
func (o *WritableTxnMarkerTopicResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *WritableTxnMarkerTopicResult) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func WritableTxnMarkerTopicResultDefault() WritableTxnMarkerTopicResult {
	var d WritableTxnMarkerTopicResult
	d.SetDefault()
