...
package writabletxnmarkertopicresult
...
var writableTxnMarkerPartitionResultPartitionIndex = fields.Context{
...
var writableTxnMarkerPartitionResultErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  1,
...
func (o *WritableTxnMarkerPartitionResult) Read(buf *bytes.Reader, version int16) error {
	...
	partitionIndexField := fields.Int32{Context: writableTxnMarkerPartitionResultPartitionIndex}
	...
	errorCodeField := fields.Int16{Context: writableTxnMarkerPartitionResultErrorCode}
	...
	if version < WritableTxnMarkerPartitionResultLowestSupportedFlexVersion() || version > WritableTxnMarkerPartitionResultHighestSupportedFlexVersion() {
...
func (o *WritableTxnMarkerPartitionResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *WritableTxnMarkerPartitionResult) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func WritableTxnMarkerPartitionResultDefault() WritableTxnMarkerPartitionResult {
	var d WritableTxnMarkerPartitionResult
	d.SetDefault()
