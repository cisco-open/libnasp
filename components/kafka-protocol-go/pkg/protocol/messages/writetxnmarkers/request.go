...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/writetxnmarkers/request"
...
var requestMarkers = fields.Context{
	SpecName:                    "Markers",
...
type Request struct {
	...
	markers             []request.WritableTxnMarker
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Markers() []request.WritableTxnMarker {
	return o.markers
}

func (o *Request) SetMarkers(val []request.WritableTxnMarker) {
	o.isNil = false
	o.markers = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	markersField := fields.ArrayOfStruct[request.WritableTxnMarker, *request.WritableTxnMarker]{Context: requestMarkers}
