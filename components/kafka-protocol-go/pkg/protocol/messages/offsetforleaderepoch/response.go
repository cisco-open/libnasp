...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetforleaderepoch/response"
...
type Response struct {
	topics              []response.OffsetForLeaderTopicResult
...
func (o *Response) Topics() []response.OffsetForLeaderTopicResult {
	return o.topics
}

func (o *Response) SetTopics(val []response.OffsetForLeaderTopicResult) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.OffsetForLeaderTopicResult, *response.OffsetForLeaderTopicResult]{Context: responseTopics}
