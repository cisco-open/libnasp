...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describequorum/common"
...
var partitionDataCurrentVoters = fields.Context{
	SpecName:                    "CurrentVoters",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
}
var partitionDataObservers = fields.Context{
	SpecName:                    "Observers",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
...
type PartitionData struct {
	currentVoters       []common.ReplicaState
	observers           []common.ReplicaState
...
func (o *PartitionData) CurrentVoters() []common.ReplicaState {
	return o.currentVoters
}

func (o *PartitionData) SetCurrentVoters(val []common.ReplicaState) {
	o.isNil = false
	o.currentVoters = val
}

func (o *PartitionData) Observers() []common.ReplicaState {
	return o.observers
}

func (o *PartitionData) SetObservers(val []common.ReplicaState) {
	o.isNil = false
	o.observers = val
}
...
func (o *PartitionData) Read(buf *bytes.Reader, version int16) error {
	...
	currentVotersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataCurrentVoters}
	currentVoters, err := currentVotersField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"currentVoters\" field")
	}
	o.currentVoters = currentVoters

	observersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataObservers}
	observers, err := observersField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"observers\" field")
	}
...
func (o *PartitionData) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	currentVotersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataCurrentVoters}
	if err := currentVotersField.Write(buf, version, o.currentVoters); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"currentVoters\" field")
	}

	observersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataObservers}
	if err := observersField.Write(buf, version, o.observers); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"observers\" field")
	}
...
func (o *PartitionData) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayOfStructMarshalJSON("currentVoters", o.currentVoters); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
	if b, err := fields.ArrayOfStructMarshalJSON("observers", o.observers); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *PartitionData) SetDefault() {
	...
	o.leaderEpoch = 0
	o.highWatermark = 0
	for i := range o.currentVoters {
		o.currentVoters[i].Release()
	}
	o.currentVoters = nil
	for i := range o.observers {
		o.observers[i].Release()
	}
	o.observers = nil
...
func (o *PartitionData) Equal(that *PartitionData) bool {
	...
	if len(o.currentVoters) != len(that.currentVoters) {
		return false
	}
	for i := range o.currentVoters {
		if !o.currentVoters[i].Equal(&that.currentVoters[i]) {
			return false
		}
	}
	if len(o.observers) != len(that.observers) {
		return false
	}
	for i := range o.observers {
		if !o.observers[i].Equal(&that.observers[i]) {
			return false
		}
	}
...
func (o *PartitionData) SizeInBytes(version int16) (int, error) {
	...
	currentVotersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataCurrentVoters}
	fieldSize, err = currentVotersField.SizeInBytes(version, o.currentVoters)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"currentVoters\" field")
	}
	size += fieldSize

	observersField := fields.ArrayOfStruct[common.ReplicaState, *common.ReplicaState]{Context: partitionDataObservers}
	fieldSize, err = observersField.SizeInBytes(version, o.observers)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"observers\" field")
	}
	size += fieldSize
