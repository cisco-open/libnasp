...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterpartition/response/topicdata"
...
var topicDataTopicId = fields.Context{
	SpecName:                    "TopicId",
...
func (o *TopicData) TopicId() fields.UUID {
	return o.topicId
}

func (o *TopicData) SetTopicId(val fields.UUID) {
	o.isNil = false
	o.topicId = val
}
...
func (o *TopicData) Read(buf *bytes.Reader, version int16) error {
	...
	topicIdField := fields.Uuid{Context: topicDataTopicId}
