...
var requestTransactionTimeoutMs = fields.Context{
...
func (o *Request) TransactionTimeoutMs() int32 {
	return o.transactionTimeoutMs
}

func (o *Request) SetTransactionTimeoutMs(val int32) {
	o.isNil = false
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	transactionTimeoutMsField := fields.Int32{Context: requestTransactionTimeoutMs}
...
func (o *Request) validateNonIgnorableFields(version int16) error {
	if !requestProducerId.IsSupportedVersion(version) {
		if o.producerId != -1 {
			return errors.New(strings.Join([]string{"attempted to write non-default \"producerId\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	if !requestProducerEpoch.IsSupportedVersion(version) {
		if o.producerEpoch != -1 {
			return errors.New(strings.Join([]string{"attempted to write non-default \"producerEpoch\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	return nil
}
