...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/addpartitionstotxn/response/addpartitionstotxntopicresult"
...
var addPartitionsToTxnTopicResultName = fields.Context{
	SpecName:                    "Name",
...
var addPartitionsToTxnTopicResultResults = fields.Context{
	SpecName:                    "Results",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  3,
...
type AddPartitionsToTxnTopicResult struct {
	results             []addpartitionstotxntopicresult.AddPartitionsToTxnPartitionResult
...
func (o *AddPartitionsToTxnTopicResult) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: addPartitionsToTxnTopicResultName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	resultsField := fields.ArrayOfStruct[addpartitionstotxntopicresult.AddPartitionsToTxnPartitionResult, *addpartitionstotxntopicresult.AddPartitionsToTxnPartitionResult]{Context: addPartitionsToTxnTopicResultResults}
	...
	if version < AddPartitionsToTxnTopicResultLowestSupportedFlexVersion() || version > AddPartitionsToTxnTopicResultHighestSupportedFlexVersion() {
...
func (o *AddPartitionsToTxnTopicResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *AddPartitionsToTxnTopicResult) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func AddPartitionsToTxnTopicResultDefault() AddPartitionsToTxnTopicResult {
	var d AddPartitionsToTxnTopicResult
	d.SetDefault()
