...
package addpartitionstotxntopicresult
...
var addPartitionsToTxnPartitionResultPartitionIndex = fields.Context{
...
var addPartitionsToTxnPartitionResultErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  3,
...
func (o *AddPartitionsToTxnPartitionResult) Read(buf *bytes.Reader, version int16) error {
	...
	partitionIndexField := fields.Int32{Context: addPartitionsToTxnPartitionResultPartitionIndex}
	...
	errorCodeField := fields.Int16{Context: addPartitionsToTxnPartitionResultErrorCode}
	...
	if version < AddPartitionsToTxnPartitionResultLowestSupportedFlexVersion() || version > AddPartitionsToTxnPartitionResultHighestSupportedFlexVersion() {
...
func (o *AddPartitionsToTxnPartitionResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *AddPartitionsToTxnPartitionResult) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func AddPartitionsToTxnPartitionResultDefault() AddPartitionsToTxnPartitionResult {
	var d AddPartitionsToTxnPartitionResult
	d.SetDefault()
