...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/addpartitionstotxn/response"
...
type Response struct {
	results             []response.AddPartitionsToTxnTopicResult
...
func (o *Response) Results() []response.AddPartitionsToTxnTopicResult {
	return o.results
}

func (o *Response) SetResults(val []response.AddPartitionsToTxnTopicResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.AddPartitionsToTxnTopicResult, *response.AddPartitionsToTxnTopicResult]{Context: responseResults}
