...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/addpartitionstotxn/request"
...
type Request struct {
	topics              []request.AddPartitionsToTxnTopic
...
func (o *Request) Topics() []request.AddPartitionsToTxnTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.AddPartitionsToTxnTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.AddPartitionsToTxnTopic, *request.AddPartitionsToTxnTopic]{Context: requestTopics}
