...
var requestAuthBytes = fields.Context{
	SpecName:                    "AuthBytes",
...
func (o *Request) AuthBytes() []byte {
	return o.authBytes
}

func (o *Request) SetAuthBytes(val []byte) {
	o.isNil = false
	o.authBytes = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	authBytesField := fields.Bytes{Context: requestAuthBytes}
