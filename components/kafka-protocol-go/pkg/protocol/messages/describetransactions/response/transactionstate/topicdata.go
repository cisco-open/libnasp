...
var topicDataTopic = fields.Context{
	SpecName:                    "Topic",
...
func (o *TopicData) Topic() fields.NullableString {
	return o.topic
}

func (o *TopicData) SetTopic(val fields.NullableString) {
	o.isNil = false
	o.topic = val
}

func (o *TopicData) Partitions() []int32 {
	return o.partitions
}

func (o *TopicData) SetPartitions(val []int32) {
	o.isNil = false
	o.partitions = val
}
...
func (o *TopicData) Read(buf *bytes.Reader, version int16) error {
	...
	topicField := fields.String{Context: topicDataTopic}
	...
	partitionsField := fields.Array[int32, *fields.Int32]{
		Context:          topicDataPartitions,
		ElementProcessor: &fields.Int32{Context: topicDataPartitions}}
