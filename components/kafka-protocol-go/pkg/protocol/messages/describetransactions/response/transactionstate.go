...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describetransactions/response/transactionstate"
...
var transactionStateErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
...
var transactionStateTransactionTimeoutMs = fields.Context{
	SpecName:                    "TransactionTimeoutMs",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
}
var transactionStateTransactionStartTimeMs = fields.Context{
	SpecName:                    "TransactionStartTimeMs",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
	HighestSupportedFlexVersion: 32767,
...
var transactionStateProducerEpoch = fields.Context{
...
var transactionStateTopics = fields.Context{
	SpecName:                    "Topics",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
...
type TransactionState struct {
	topics                 []transactionstate.TopicData
...
func (o *TransactionState) ErrorCode() int16 {
	return o.errorCode
}

func (o *TransactionState) SetErrorCode(val int16) {
	o.isNil = false
	o.errorCode = val
}
...
func (o *TransactionState) TransactionTimeoutMs() int32 {
	return o.transactionTimeoutMs
}

func (o *TransactionState) SetTransactionTimeoutMs(val int32) {
	o.isNil = false
	o.transactionTimeoutMs = val
}

func (o *TransactionState) TransactionStartTimeMs() int64 {
	return o.transactionStartTimeMs
}

func (o *TransactionState) SetTransactionStartTimeMs(val int64) {
	o.isNil = false
	o.transactionStartTimeMs = val
}
...
func (o *TransactionState) ProducerEpoch() int16 {
	return o.producerEpoch
}

func (o *TransactionState) SetProducerEpoch(val int16) {
	o.isNil = false
	o.producerEpoch = val
}

func (o *TransactionState) Topics() []transactionstate.TopicData {
	return o.topics
}

func (o *TransactionState) SetTopics(val []transactionstate.TopicData) {
	o.isNil = false
	o.topics = val
}
...
func (o *TransactionState) Read(buf *bytes.Reader, version int16) error {
	...
	errorCodeField := fields.Int16{Context: transactionStateErrorCode}
	...
	transactionTimeoutMsField := fields.Int32{Context: transactionStateTransactionTimeoutMs}
	if err := transactionTimeoutMsField.Read(buf, version, &o.transactionTimeoutMs); err != nil {
		return errors.WrapIf(err, "couldn't set \"transactionTimeoutMs\" field")
	}

	transactionStartTimeMsField := fields.Int64{Context: transactionStateTransactionStartTimeMs}
	if err := transactionStartTimeMsField.Read(buf, version, &o.transactionStartTimeMs); err != nil {
		return errors.WrapIf(err, "couldn't set \"transactionStartTimeMs\" field")
	}
	...
	producerEpochField := fields.Int16{Context: transactionStateProducerEpoch}
	...
	topicsField := fields.ArrayOfStruct[transactionstate.TopicData, *transactionstate.TopicData]{Context: transactionStateTopics}
...
func (o *TransactionState) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	transactionTimeoutMsField := fields.Int32{Context: transactionStateTransactionTimeoutMs}
	if err := transactionTimeoutMsField.Write(buf, version, o.transactionTimeoutMs); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"transactionTimeoutMs\" field")
	}
	transactionStartTimeMsField := fields.Int64{Context: transactionStateTransactionStartTimeMs}
	if err := transactionStartTimeMsField.Write(buf, version, o.transactionStartTimeMs); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"transactionStartTimeMs\" field")
	}
	producerIdField := fields.Int64{Context: transactionStateProducerId}
...
func (o *TransactionState) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.transactionTimeoutMs); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"transactionTimeoutMs\""), b}, []byte(": ")))
	}
	if b, err := fields.MarshalPrimitiveTypeJSON(o.transactionStartTimeMs); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"transactionStartTimeMs\""), b}, []byte(": ")))
	}
...
func (o *TransactionState) SetDefault() {
	...
	o.transactionTimeoutMs = 0
	o.transactionStartTimeMs = 0
	o.producerId = 0
	o.producerEpoch = 0
...
func (o *TransactionState) Equal(that *TransactionState) bool {
	...
	if o.transactionTimeoutMs != that.transactionTimeoutMs {
		return false
	}
	if o.transactionStartTimeMs != that.transactionStartTimeMs {
		return false
	}
...
func (o *TransactionState) SizeInBytes(version int16) (int, error) {
	...
	transactionTimeoutMsField := fields.Int32{Context: transactionStateTransactionTimeoutMs}
	fieldSize, err = transactionTimeoutMsField.SizeInBytes(version, o.transactionTimeoutMs)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"transactionTimeoutMs\" field")
	}
	size += fieldSize

	transactionStartTimeMsField := fields.Int64{Context: transactionStateTransactionStartTimeMs}
	fieldSize, err = transactionStartTimeMsField.SizeInBytes(version, o.transactionStartTimeMs)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"transactionStartTimeMs\" field")
	}
	size += fieldSize
