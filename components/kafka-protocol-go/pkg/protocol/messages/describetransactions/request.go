...
var requestTransactionalIds = fields.Context{
	SpecName:                    "TransactionalIds",
...
type Request struct {
	...
	transactionalIds    []fields.NullableString
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) TransactionalIds() []fields.NullableString {
	return o.transactionalIds
}

func (o *Request) SetTransactionalIds(val []fields.NullableString) {
	o.isNil = false
	o.transactionalIds = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	transactionalIdsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestTransactionalIds,
		ElementProcessor: &fields.String{Context: requestTransactionalIds}}

	transactionalIds, err := transactionalIdsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"transactionalIds\" field")
	}
	o.transactionalIds = transactionalIds
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	transactionalIdsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestTransactionalIds,
		ElementProcessor: &fields.String{Context: requestTransactionalIds}}
	if err := transactionalIdsField.Write(buf, version, o.transactionalIds); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"transactionalIds\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayMarshalJSON("transactionalIds", o.transactionalIds); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) SetDefault() {
	...
	o.unknownTaggedFields = nil
	for i := range o.transactionalIds {
		o.transactionalIds[i].Release()
	}
	o.transactionalIds = nil
...
func (o *Request) Equal(that *Request) bool {
	...
	if !fields.NullableStringSliceEqual(o.transactionalIds, that.transactionalIds) {
		return false
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	transactionalIdsField := fields.Array[fields.NullableString, *fields.String]{
		Context:          requestTransactionalIds,
		ElementProcessor: &fields.String{Context: requestTransactionalIds}}
	fieldSize, err = transactionalIdsField.SizeInBytes(version, o.transactionalIds)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"transactionalIds\" field")
	}
	size += fieldSize
