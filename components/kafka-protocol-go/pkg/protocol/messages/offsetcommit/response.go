...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetcommit/response"
...
type Response struct {
	topics              []response.OffsetCommitResponseTopic
...
func (o *Response) Topics() []response.OffsetCommitResponseTopic {
	return o.topics
}

func (o *Response) SetTopics(val []response.OffsetCommitResponseTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.OffsetCommitResponseTopic, *response.OffsetCommitResponseTopic]{Context: responseTopics}
