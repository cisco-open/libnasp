...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetcommit/request"
...
var requestRetentionTimeMs = fields.Context{
	SpecName:                    "RetentionTimeMs",
...
type Request struct {
	topics              []request.OffsetCommitRequestTopic
...
func (o *Request) RetentionTimeMs() int64 {
	return o.retentionTimeMs
}

func (o *Request) SetRetentionTimeMs(val int64) {
	o.isNil = false
	o.retentionTimeMs = val
}

func (o *Request) Topics() []request.OffsetCommitRequestTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.OffsetCommitRequestTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	retentionTimeMsField := fields.Int64{Context: requestRetentionTimeMs}
	if err := retentionTimeMsField.Read(buf, version, &o.retentionTimeMs); err != nil {
		return errors.WrapIf(err, "couldn't set \"retentionTimeMs\" field")
	}

	topicsField := fields.ArrayOfStruct[request.OffsetCommitRequestTopic, *request.OffsetCommitRequestTopic]{Context: requestTopics}
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	retentionTimeMsField := fields.Int64{Context: requestRetentionTimeMs}
	if err := retentionTimeMsField.Write(buf, version, o.retentionTimeMs); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"retentionTimeMs\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.retentionTimeMs); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"retentionTimeMs\""), b}, []byte(": ")))
	}
...
func (o *Request) Equal(that *Request) bool {
	...
	if o.retentionTimeMs != that.retentionTimeMs {
		return false
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	retentionTimeMsField := fields.Int64{Context: requestRetentionTimeMs}
	fieldSize, err = retentionTimeMsField.SizeInBytes(version, o.retentionTimeMs)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"retentionTimeMs\" field")
	}
	size += fieldSize
