...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetcommit/response/offsetcommitresponsetopic"
...
var offsetCommitResponseTopicName = fields.Context{
	SpecName:                    "Name",
...
var offsetCommitResponseTopicPartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  8,
...
type OffsetCommitResponseTopic struct {
	partitions          []offsetcommitresponsetopic.OffsetCommitResponsePartition
...
func (o *OffsetCommitResponseTopic) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: offsetCommitResponseTopicName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionsField := fields.ArrayOfStruct[offsetcommitresponsetopic.OffsetCommitResponsePartition, *offsetcommitresponsetopic.OffsetCommitResponsePartition]{Context: offsetCommitResponseTopicPartitions}
	...
	if version < OffsetCommitResponseTopicLowestSupportedFlexVersion() || version > OffsetCommitResponseTopicHighestSupportedFlexVersion() {
...
func (o *OffsetCommitResponseTopic) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *OffsetCommitResponseTopic) validateNonIgnorableFields(version int16) error {
	return nil
}
...
func OffsetCommitResponseTopicDefault() OffsetCommitResponseTopic {
	var d OffsetCommitResponseTopic
	d.SetDefault()
