...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterreplicalogdirs/request"
...
var requestDirs = fields.Context{
	SpecName:                    "Dirs",
...
type Request struct {
	...
	dirs                []request.AlterReplicaLogDir
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Dirs() []request.AlterReplicaLogDir {
	return o.dirs
}

func (o *Request) SetDirs(val []request.AlterReplicaLogDir) {
	o.isNil = false
	o.dirs = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	dirsField := fields.ArrayOfStruct[request.AlterReplicaLogDir, *request.AlterReplicaLogDir]{Context: requestDirs}
	dirs, err := dirsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"dirs\" field")
	}
	o.dirs = dirs
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	dirsField := fields.ArrayOfStruct[request.AlterReplicaLogDir, *request.AlterReplicaLogDir]{Context: requestDirs}
	if err := dirsField.Write(buf, version, o.dirs); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"dirs\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	s := make([][]byte, 0, 2)
	if b, err := fields.ArrayOfStructMarshalJSON("dirs", o.dirs); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Request) Equal(that *Request) bool {
	...
	if len(o.dirs) != len(that.dirs) {
		return false
	}
	for i := range o.dirs {
		if !o.dirs[i].Equal(&that.dirs[i]) {
			return false
		}
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	dirsField := fields.ArrayOfStruct[request.AlterReplicaLogDir, *request.AlterReplicaLogDir]{Context: requestDirs}
	fieldSize, err = dirsField.SizeInBytes(version, o.dirs)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"dirs\" field")
	}
	size += fieldSize
