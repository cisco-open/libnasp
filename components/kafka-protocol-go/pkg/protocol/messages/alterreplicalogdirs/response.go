...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/alterreplicalogdirs/response"
...
type Response struct {
	results             []response.AlterReplicaLogDirTopicResult
...
func (o *Response) Results() []response.AlterReplicaLogDirTopicResult {
	return o.results
}

func (o *Response) SetResults(val []response.AlterReplicaLogDirTopicResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.AlterReplicaLogDirTopicResult, *response.AlterReplicaLogDirTopicResult]{Context: responseResults}
