...
var topicPartitionsTopic = fields.Context{
	SpecName:                        "Topic",
...
var topicPartitionsPartitions = fields.Context{
	SpecName:                        "Partitions",
	LowestSupportedVersion:          0,
	HighestSupportedVersion:         32767,
	LowestSupportedFlexVersion:      2,
...
func (o *TopicPartitions) Read(buf *bytes.Reader, version int16) error {
	...
	topicField := fields.String{Context: topicPartitionsTopic}
	...
	partitionsField := fields.Array[int32, *fields.Int32]{
		Context:          topicPartitionsPartitions,
		ElementProcessor: &fields.Int32{Context: topicPartitionsPartitions}}
	...
	if version < TopicPartitionsLowestSupportedFlexVersion() || version > TopicPartitionsHighestSupportedFlexVersion() {
...
func (o *TopicPartitions) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *TopicPartitions) validateNonIgnorableFields(version int16) error {
	return nil
}
