...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/electleaders/response"
...
var responseReplicaElectionResults = fields.Context{
	SpecName:                    "ReplicaElectionResults",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  2,
	HighestSupportedFlexVersion: 32767,
...
type Response struct {
	replicaElectionResults []response.ReplicaElectionResult
...
func (o *Response) ReplicaElectionResults() []response.ReplicaElectionResult {
	return o.replicaElectionResults
}

func (o *Response) SetReplicaElectionResults(val []response.ReplicaElectionResult) {
	o.isNil = false
	o.replicaElectionResults = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	replicaElectionResultsField := fields.ArrayOfStruct[response.ReplicaElectionResult, *response.ReplicaElectionResult]{Context: responseReplicaElectionResults}
	replicaElectionResults, err := replicaElectionResultsField.Read(buf, version)
	if err != nil {
		return errors.WrapIf(err, "couldn't set \"replicaElectionResults\" field")
	}
	o.replicaElectionResults = replicaElectionResults
...
func (o *Response) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	replicaElectionResultsField := fields.ArrayOfStruct[response.ReplicaElectionResult, *response.ReplicaElectionResult]{Context: responseReplicaElectionResults}
	if err := replicaElectionResultsField.Write(buf, version, o.replicaElectionResults); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"replicaElectionResults\" field")
	}
...
func (o *Response) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.ArrayOfStructMarshalJSON("replicaElectionResults", o.replicaElectionResults); err != nil {
		return nil, err
	} else {
		s = append(s, b)
	}
...
func (o *Response) SetDefault() {
	...
	o.throttleTimeMs = 0
	o.errorCode = 0
	for i := range o.replicaElectionResults {
		o.replicaElectionResults[i].Release()
	}
	o.replicaElectionResults = nil
...
func (o *Response) Equal(that *Response) bool {
	...
	if len(o.replicaElectionResults) != len(that.replicaElectionResults) {
		return false
	}
	for i := range o.replicaElectionResults {
		if !o.replicaElectionResults[i].Equal(&that.replicaElectionResults[i]) {
			return false
		}
	}
...
func (o *Response) SizeInBytes(version int16) (int, error) {
	...
	replicaElectionResultsField := fields.ArrayOfStruct[response.ReplicaElectionResult, *response.ReplicaElectionResult]{Context: responseReplicaElectionResults}
	fieldSize, err = replicaElectionResultsField.SizeInBytes(version, o.replicaElectionResults)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"replicaElectionResults\" field")
	}
	size += fieldSize
...
func (o *Response) validateNonIgnorableFields(version int16) error {
	if !responseErrorCode.IsSupportedVersion(version) {
		if o.errorCode != 0 {
