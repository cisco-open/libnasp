...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/beginquorumepoch/response"
...
func (o *Response) Topics() []response.TopicData {
	return o.topics
}

func (o *Response) SetTopics(val []response.TopicData) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.TopicData, *response.TopicData]{Context: responseTopics}
