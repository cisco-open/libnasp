...
var topicRequestName = fields.Context{
	SpecName:                    "Name",
...
var topicRequestPartitionIndexes = fields.Context{
...
func (o *TopicRequest) Name() fields.NullableString {
	return o.name
}

func (o *TopicRequest) SetName(val fields.NullableString) {
	o.isNil = false
	o.name = val
}

func (o *TopicRequest) PartitionIndexes() []int32 {
	return o.partitionIndexes
}

func (o *TopicRequest) SetPartitionIndexes(val []int32) {
	o.isNil = false
	o.partitionIndexes = val
}

func (o *TopicRequest) UnknownTaggedFields() []fields.RawTaggedField {
	return o.unknownTaggedFields
}

func (o *TopicRequest) SetUnknownTaggedFields(val []fields.RawTaggedField) {
	o.unknownTaggedFields = val
}

func (o *TopicRequest) Read(buf *bytes.Reader, version int16) error {
	o.SetDefault()

	nameField := fields.String{Context: topicRequestName}
	...
	partitionIndexesField := fields.Array[int32, *fields.Int32]{
		Context:          topicRequestPartitionIndexes,
		ElementProcessor: &fields.Int32{Context: topicRequestPartitionIndexes}}
	...
	if version < TopicRequestLowestSupportedFlexVersion() || version > TopicRequestHighestSupportedFlexVersion() {
...
func (o *TopicRequest) Write(buf *typesbytes.SliceWriter, version int16) error {
	if o.IsNil() {
		return nil
	}
...
func (o *TopicRequest) IsNil() bool {
	return o.isNil
}

func (o *TopicRequest) Clear() {
	o.Release()
	o.isNil = true
...
func (o *TopicRequest) SetDefault() {
...
func (o *TopicRequest) Equal(that *TopicRequest) bool {
...
func (o *TopicRequest) SizeInBytes(version int16) (int, error) {
	if o.IsNil() {
		return 0, nil
	}
...
func (o *TopicRequest) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *TopicRequest) validateNonIgnorableFields(version int16) error {
	return nil
}

func TopicRequestLowestSupportedVersion() int16 {
	return 0
}

func TopicRequestHighestSupportedVersion() int16 {
	return 32767
}

func TopicRequestLowestSupportedFlexVersion() int16 {
	return 0
}

func TopicRequestHighestSupportedFlexVersion() int16 {
	return 32767
}

func TopicRequestDefault() TopicRequest {
	var d TopicRequest
	d.SetDefault()
