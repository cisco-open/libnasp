...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeproducers/response/topicresponse"
...
var topicResponseName = fields.Context{
	SpecName:                    "Name",
...
var topicResponsePartitions = fields.Context{
	SpecName:                    "Partitions",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  0,
...
type TopicResponse struct {
	partitions          []topicresponse.PartitionResponse
	unknownTaggedFields []fields.RawTaggedField
	name                fields.NullableString
	isNil               bool
}

func (o *TopicResponse) Name() fields.NullableString {
	return o.name
}
...
func (o *TopicResponse) Read(buf *bytes.Reader, version int16) error {
	...
	nameField := fields.String{Context: topicResponseName}
	if err := nameField.Read(buf, version, &o.name); err != nil {
		return errors.WrapIf(err, "couldn't set \"name\" field")
	}

	partitionsField := fields.ArrayOfStruct[topicresponse.PartitionResponse, *topicresponse.PartitionResponse]{Context: topicResponsePartitions}
	...
	if version < TopicResponseLowestSupportedFlexVersion() || version > TopicResponseHighestSupportedFlexVersion() {
...
func (o *TopicResponse) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *TopicResponse) validateNonIgnorableFields(version int16) error {
	return nil
}
