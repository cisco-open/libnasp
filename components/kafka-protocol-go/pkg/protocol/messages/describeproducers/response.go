...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeproducers/response"
...
func (o *Response) Topics() []response.TopicResponse {
	return o.topics
}

func (o *Response) SetTopics(val []response.TopicResponse) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.TopicResponse, *response.TopicResponse]{Context: responseTopics}
