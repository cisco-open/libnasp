...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeproducers/request"
...
type Request struct {
	topics              []request.TopicRequest
	unknownTaggedFields []fields.RawTaggedField

	isNil bool
}

func (o *Request) Topics() []request.TopicRequest {
	return o.topics
}

func (o *Request) SetTopics(val []request.TopicRequest) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.TopicRequest, *request.TopicRequest]{Context: requestTopics}
