...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeconfigs/response/describeconfigsresult"
...
var describeConfigsResultErrorCode = fields.Context{
	SpecName:                    "ErrorCode",
...
var describeConfigsResultErrorMessage = fields.Context{
...
var describeConfigsResultResourceType = fields.Context{
...
var describeConfigsResultResourceName = fields.Context{
...
var describeConfigsResultConfigs = fields.Context{
	SpecName:                    "Configs",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  4,
...
type DescribeConfigsResult struct {
	configs             []describeconfigsresult.DescribeConfigsResourceResult
...
func (o *DescribeConfigsResult) ErrorCode() int16 {
	return o.errorCode
}

func (o *DescribeConfigsResult) SetErrorCode(val int16) {
	o.isNil = false
	o.errorCode = val
}

func (o *DescribeConfigsResult) ErrorMessage() fields.NullableString {
	return o.errorMessage
}

func (o *DescribeConfigsResult) SetErrorMessage(val fields.NullableString) {
	o.isNil = false
	o.errorMessage = val
}

func (o *DescribeConfigsResult) ResourceType() int8 {
	return o.resourceType
}

func (o *DescribeConfigsResult) SetResourceType(val int8) {
	o.isNil = false
	o.resourceType = val
}

func (o *DescribeConfigsResult) ResourceName() fields.NullableString {
	return o.resourceName
}

func (o *DescribeConfigsResult) SetResourceName(val fields.NullableString) {
	o.isNil = false
	o.resourceName = val
}

func (o *DescribeConfigsResult) Configs() []describeconfigsresult.DescribeConfigsResourceResult {
	return o.configs
}

func (o *DescribeConfigsResult) SetConfigs(val []describeconfigsresult.DescribeConfigsResourceResult) {
	o.isNil = false
	o.configs = val
}

func (o *DescribeConfigsResult) UnknownTaggedFields() []fields.RawTaggedField {
	return o.unknownTaggedFields
}

func (o *DescribeConfigsResult) SetUnknownTaggedFields(val []fields.RawTaggedField) {
	o.unknownTaggedFields = val
}

func (o *DescribeConfigsResult) Read(buf *bytes.Reader, version int16) error {
	o.SetDefault()

	errorCodeField := fields.Int16{Context: describeConfigsResultErrorCode}
	if err := errorCodeField.Read(buf, version, &o.errorCode); err != nil {
		return errors.WrapIf(err, "couldn't set \"errorCode\" field")
	}

	errorMessageField := fields.String{Context: describeConfigsResultErrorMessage}
	if err := errorMessageField.Read(buf, version, &o.errorMessage); err != nil {
		return errors.WrapIf(err, "couldn't set \"errorMessage\" field")
	}

	resourceTypeField := fields.Int8{Context: describeConfigsResultResourceType}
	if err := resourceTypeField.Read(buf, version, &o.resourceType); err != nil {
		return errors.WrapIf(err, "couldn't set \"resourceType\" field")
	}

	resourceNameField := fields.String{Context: describeConfigsResultResourceName}
	if err := resourceNameField.Read(buf, version, &o.resourceName); err != nil {
		return errors.WrapIf(err, "couldn't set \"resourceName\" field")
	}

	configsField := fields.ArrayOfStruct[describeconfigsresult.DescribeConfigsResourceResult, *describeconfigsresult.DescribeConfigsResourceResult]{Context: describeConfigsResultConfigs}
	...
	if version < DescribeConfigsResultLowestSupportedFlexVersion() || version > DescribeConfigsResultHighestSupportedFlexVersion() {
...
func (o *DescribeConfigsResult) Write(buf *typesbytes.SliceWriter, version int16) error {
	if o.IsNil() {
		return nil
	}
...
func (o *DescribeConfigsResult) String() string {
	s, err := o.MarshalJSON()
	if err != nil {
		return err.Error()
	}
...
func (o *DescribeConfigsResult) MarshalJSON() ([]byte, error) {
	if o == nil || o.IsNil() {
...
func (o *DescribeConfigsResult) IsNil() bool {
	return o.isNil
}

func (o *DescribeConfigsResult) Clear() {
	o.Release()
	o.isNil = true
...
func (o *DescribeConfigsResult) SetDefault() {
...
func (o *DescribeConfigsResult) Equal(that *DescribeConfigsResult) bool {
...
func (o *DescribeConfigsResult) SizeInBytes(version int16) (int, error) {
	if o.IsNil() {
		return 0, nil
	}
...
func (o *DescribeConfigsResult) Release() {
	if o.IsNil() {
		return
	}
...
func (o *DescribeConfigsResult) getTaggedFieldsCount(version int16) int {
...
// non-default value
func (o *DescribeConfigsResult) validateNonIgnorableFields(version int16) error {
	return nil
}

func DescribeConfigsResultLowestSupportedVersion() int16 {
	return 0
}

func DescribeConfigsResultHighestSupportedVersion() int16 {
	return 32767
}

func DescribeConfigsResultLowestSupportedFlexVersion() int16 {
	return 4
}

func DescribeConfigsResultHighestSupportedFlexVersion() int16 {
	return 32767
}

func DescribeConfigsResultDefault() DescribeConfigsResult {
	var d DescribeConfigsResult
	d.SetDefault()
