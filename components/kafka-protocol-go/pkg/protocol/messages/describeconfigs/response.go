...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/describeconfigs/response"
...
type Response struct {
	results             []response.DescribeConfigsResult
...
func (o *Response) Results() []response.DescribeConfigsResult {
	return o.results
}

func (o *Response) SetResults(val []response.DescribeConfigsResult) {
	o.isNil = false
	o.results = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	resultsField := fields.ArrayOfStruct[response.DescribeConfigsResult, *response.DescribeConfigsResult]{Context: responseResults}
