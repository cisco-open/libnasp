...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/createtopics/response"
...
type Response struct {
	topics              []response.CreatableTopicResult
...
func (o *Response) Topics() []response.CreatableTopicResult {
	return o.topics
}

func (o *Response) SetTopics(val []response.CreatableTopicResult) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.CreatableTopicResult, *response.CreatableTopicResult]{Context: responseTopics}
