...
var requestCommitted = fields.Context{
	SpecName:                    "Committed",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  3,
...
func (o *Request) Committed() bool {
	return o.committed
}

func (o *Request) SetCommitted(val bool) {
	o.isNil = false
	o.committed = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	committedField := fields.Bool{Context: requestCommitted}
	if err := committedField.Read(buf, version, &o.committed); err != nil {
		return errors.WrapIf(err, "couldn't set \"committed\" field")
	}
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	committedField := fields.Bool{Context: requestCommitted}
	if err := committedField.Write(buf, version, o.committed); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"committed\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.committed); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"committed\""), b}, []byte(": ")))
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	committedField := fields.Bool{Context: requestCommitted}
	fieldSize, err = committedField.SizeInBytes(version, o.committed)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"committed\" field")
	}
	size += fieldSize
