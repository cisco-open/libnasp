...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetdelete/response"
...
type Response struct {
	topics              []response.OffsetDeleteResponseTopic
...
func (o *Response) Topics() []response.OffsetDeleteResponseTopic {
	return o.topics
}

func (o *Response) SetTopics(val []response.OffsetDeleteResponseTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.OffsetDeleteResponseTopic, *response.OffsetDeleteResponseTopic]{Context: responseTopics}
