...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/offsetdelete/request"
...
type Request struct {
	topics              []request.OffsetDeleteRequestTopic
...
func (o *Request) Topics() []request.OffsetDeleteRequestTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.OffsetDeleteRequestTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.OffsetDeleteRequestTopic, *request.OffsetDeleteRequestTopic]{Context: requestTopics}
