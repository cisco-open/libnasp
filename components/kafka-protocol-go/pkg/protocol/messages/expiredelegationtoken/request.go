...
var requestExpiryTimePeriodMs = fields.Context{
	SpecName:                    "ExpiryTimePeriodMs",
	LowestSupportedVersion:      0,
	HighestSupportedVersion:     32767,
	LowestSupportedFlexVersion:  2,
	HighestSupportedFlexVersion: 32767,
...
func (o *Request) ExpiryTimePeriodMs() int64 {
	return o.expiryTimePeriodMs
}

func (o *Request) SetExpiryTimePeriodMs(val int64) {
	o.isNil = false
	o.expiryTimePeriodMs = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	expiryTimePeriodMsField := fields.Int64{Context: requestExpiryTimePeriodMs}
	if err := expiryTimePeriodMsField.Read(buf, version, &o.expiryTimePeriodMs); err != nil {
		return errors.WrapIf(err, "couldn't set \"expiryTimePeriodMs\" field")
	}
...
func (o *Request) Write(buf *typesbytes.SliceWriter, version int16) error {
	...
	expiryTimePeriodMsField := fields.Int64{Context: requestExpiryTimePeriodMs}
	if err := expiryTimePeriodMsField.Write(buf, version, o.expiryTimePeriodMs); err != nil {
		return errors.WrapIf(err, "couldn't serialize \"expiryTimePeriodMs\" field")
	}
...
func (o *Request) MarshalJSON() ([]byte, error) {
	...
	if b, err := fields.MarshalPrimitiveTypeJSON(o.expiryTimePeriodMs); err != nil {
		return nil, err
	} else {
		s = append(s, bytes.Join([][]byte{[]byte("\"expiryTimePeriodMs\""), b}, []byte(": ")))
	}
...
func (o *Request) Equal(that *Request) bool {
	...
	if o.expiryTimePeriodMs != that.expiryTimePeriodMs {
		return false
	}
...
func (o *Request) SizeInBytes(version int16) (int, error) {
	...
	expiryTimePeriodMsField := fields.Int64{Context: requestExpiryTimePeriodMs}
	fieldSize, err = expiryTimePeriodMsField.SizeInBytes(version, o.expiryTimePeriodMs)
	if err != nil {
		return 0, errors.WrapIf(err, "couldn't compute size of \"expiryTimePeriodMs\" field")
	}
	size += fieldSize
