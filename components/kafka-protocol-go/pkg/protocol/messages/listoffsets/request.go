...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listoffsets/request"
...
type Request struct {
	topics              []request.ListOffsetsTopic
...
func (o *Request) Topics() []request.ListOffsetsTopic {
	return o.topics
}

func (o *Request) SetTopics(val []request.ListOffsetsTopic) {
	o.isNil = false
	o.topics = val
}
...
func (o *Request) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[request.ListOffsetsTopic, *request.ListOffsetsTopic]{Context: requestTopics}
...
func (o *Request) validateNonIgnorableFields(version int16) error {
	if !requestIsolationLevel.IsSupportedVersion(version) {
		if o.isolationLevel != 0 {
			return errors.New(strings.Join([]string{"attempted to write non-default \"isolationLevel\" at version", strconv.Itoa(int(version))}, " "))
		}
	}
	return nil
}
