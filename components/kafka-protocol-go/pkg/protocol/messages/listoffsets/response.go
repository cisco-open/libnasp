...
import (
	...
	"emperror.dev/errors"
	"github.com/cisco-open/libnasp/components/kafka-protocol-go/pkg/protocol/messages/listoffsets/response"
...
type Response struct {
	topics              []response.ListOffsetsTopicResponse
...
func (o *Response) Topics() []response.ListOffsetsTopicResponse {
	return o.topics
}

func (o *Response) SetTopics(val []response.ListOffsetsTopicResponse) {
	o.isNil = false
	o.topics = val
}
...
func (o *Response) Read(buf *bytes.Reader, version int16) error {
	...
	topicsField := fields.ArrayOfStruct[response.ListOffsetsTopicResponse, *response.ListOffsetsTopicResponse]{Context: responseTopics}
